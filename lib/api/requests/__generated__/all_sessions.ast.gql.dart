...
const AllSessions = _i1.OperationDefinitionNode(
  type: _i1.OperationType.query,
  name: _i1.NameNode(value: 'AllSessions'),
  variableDefinitions: [],
  directives: [],
    ...
    _i1.FieldNode(
      ...
      arguments: [
        _i1.ArgumentNode(
          ...
          value: _i1.IntValueNode(value: '500'),
        )
      ],
      directives: [],
      selectionSet: _i1.SelectionSetNode(selections: [
...
const document = _i1.DocumentNode(definitions: [AllSessions]);
